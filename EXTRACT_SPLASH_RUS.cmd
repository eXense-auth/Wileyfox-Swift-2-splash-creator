...
echo.	Полученные изображения вы можете найти 
echo.	в папке output/extracted_logo folder
echo.
echo.
echo.	   /o/.                         `:+s    
echo.	   NMMMNy+.                  :sdMMMM/   
